...
struct PresentMeView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            currentColor = Color(uiColor: passedInLearner?.favouriteColor ?? .gray)
...
struct PresentMeView_Previews: PreviewProvider {
    static func updateColor(value: UIColor) {}
    static var previews: some View {
        let learnerPreview = learners[0]
        PresentMeView(passedInLearner: learnerPreview, updateColor: updateColor)
